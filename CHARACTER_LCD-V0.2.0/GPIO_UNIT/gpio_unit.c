...
void GPIO_WritePin(volatile uint8_t *GPIOx , uint8_t GPIO_Pin , uint8_t PinState) /* Function for write data to output */
{
...
void GPIO_ClearPin(volatile uint8_t *GPIOx , uint8_t GPIO_Pin) /* Function for clear pin */
{
...
uint8_t GPIO_ReadPin(volatile uint8_t *GPIOx , uint8_t GPIO_Pin) /* Function for read pin state */
{
...
uint8_t GPIO_ReadPort(volatile uint8_t *GPIOx) /* Function for read port value */
{
...
void GPIO_TogglePin(volatile uint8_t *GPIOx , uint8_t GPIO_Pin) /* Function for toggle pin */
{
...
uint8_t GPIO_ReadRegister(volatile uint8_t *REGISTERx) /* Function for read register value */
{
